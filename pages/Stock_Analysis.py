...
import datetime
import ta
from pages.functions import plotly_figure 
from pages.functions.plotly_figure import close_chart, candlestick, RSI, Moving_avarage, MACD
...
with col2:
    if chart_type == 'Candle':
        ...
        indicators = st.selectbox('',('RSI','Moving Avarage','MACD'))   
...
if num_period =='':
    ...
    if chart_type == 'Line' and indicators == 'Moving Avarage':
        st.plotly_chart(Moving_avarage(data1,'1y'), use_container_width=True)
    ...
    if chart_type == 'Line' and indicators == 'Moving Avarage':
        st.plotly_chart(Moving_avarage(new_df1,num_period), use_container_width=True)
